Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/3734dbe858578ad4f99aa63d31447d4b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalColor = float4(0.7077566,0.7077566,0.7077566,1);
				...
				Decal1.m_DecalHueShift = (0.874 /*_DecalHueShift1*/);
