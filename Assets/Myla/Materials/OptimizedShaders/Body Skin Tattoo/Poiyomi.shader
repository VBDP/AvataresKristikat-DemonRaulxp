Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/0fb61a143f816f94ab4a61c2d328bd87"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyDetailNormal(inout PoiMods poiMods, inout PoiMesh poiMesh)
			{
				...
				#if defined(PROP_DETAILNORMALMAP) || !defined(OPTIMIZER_ENABLED)
				half3 detailNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_DetailNormalMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailNormalMapUV*/)], float4(200,200,0,0)), float4(0,0,0,0), (0.0 /*_DetailNormalMapStochastic*/)), (0.7 /*_DetailNormalMapScale*/) * poiMods.detailMask.g);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal3.m_DecalColor = float4(0.1887741,0.09779881,0.07342412,1);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				switch((1.0 /*_MatcapUVMode*/))
				{
					case 0:
					{
						...
						matcapUV = noSknewViewNormal.rg * (0.475 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 1:
					{
						...
						matcapUV = float2(dot(worldViewRight, normal0), dot(worldViewUp, normal0)) * (0.475 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 2:
					{
						...
						matcapUV = uv * (0.475 /*_MatcapBorder*/) + 0.5;
						break;
					}
				}
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.25 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.13 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				if ((0.0 /*_Matcap2SmoothnessEnabled*/))
				{
					matcap2 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap2, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap2), matcap2Smoothness) * float4(poiThemeColor(poiMods, float4(0.3572768,0.3572768,0.3572768,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(0.3572768,0.3572768,0.3572768,1).a);
				}
				else
				{
					matcap2 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap2, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap2)) * float4(poiThemeColor(poiMods, float4(0.3572768,0.3572768,0.3572768,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(0.3572768,0.3572768,0.3572768,1).a);
				}
				#else
				matcap2 = float4(poiThemeColor(poiMods, float4(0.3572768,0.3572768,0.3572768,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(0.3572768,0.3572768,0.3572768,1).a);
				#endif
				matcap2.rgb *= (0.66 /*_Matcap2Intensity*/);
				...
				{
					matcap2.rgb = hueShift(matcap2.rgb, (1.0 /*_Matcap2HueShift*/) + _Time.x * (1.0 /*_Matcap2HueShiftSpeed*/));
				}
				blendMatcap(poiLight, poiFragData, poiMods, (1.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (1.0 /*_Matcap2Multiply*/), (1.0 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/));
				#endif
				#ifdef POI_MATCAP2
				float3 normal2 = poiMesh.normals[(1.0 /*_Matcap3Normal*/)];
				matcapUV = 0;
				switch((1.0 /*_Matcap3UVMode*/))
				{
					case 0:
					{
						...
						float3 NormalBlend_MatCapUV_Base = (mul(UNITY_MATRIX_V, float4(poiCam.viewDir, 0)).rgb * float3(-1, -1, 1)) + float3(0, 0, 1);
						float3 noSknewViewNormal = NormalBlend_MatCapUV_Base * dot(NormalBlend_MatCapUV_Base, NormalBlend_MatCapUV_Detail) / NormalBlend_MatCapUV_Base.b - NormalBlend_MatCapUV_Detail;
						matcapUV = noSknewViewNormal.rg * (0.43 /*_Matcap3Border*/) + 0.5;
						break;
					}
					case 1:
					{
						float3 worldViewUp = normalize(float3(0, 1, 0) - poiCam.viewDir * dot(poiCam.viewDir, float3(0, 1, 0)));
						float3 worldViewRight = normalize(cross(poiCam.viewDir, worldViewUp));
						matcapUV = float2(dot(worldViewRight, normal2), dot(worldViewUp, normal2)) * (0.43 /*_Matcap3Border*/) + 0.5;
						break;
					}
					case 2:
					{
						...
						float2 uv = float2(dot(reflection, float3(1, 0, 0)), dot(reflection, float3(0, 1, 0)));
						matcapUV = uv * (0.43 /*_Matcap3Border*/) + 0.5;
						break;
					}
				}
				matcapUV = lerp(matcapUV, poiMesh.uv[(1.0 /*_Matcap3UVToBlend*/)], float4(0,0,0,0).xy);
				matcapUV = RotateUV(matcapUV, (0.0 /*_Matcap3Rotation*/) * PI, float2(.5, .5), 1.0f);
				if (IsInMirror())
				{
					matcapUV.x = 1 - matcapUV.x;
				}
				...
				if ((0.0 /*_Matcap3SmoothnessEnabled*/))
				{
					...
					matcap3Smoothness = (1.0 /*_Matcap3Smoothness*/);
				...
				if ((0.0 /*_Matcap3SmoothnessEnabled*/))
				{
					matcap3 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap3, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap3), matcap3Smoothness) * float4(poiThemeColor(poiMods, float4(0.9822506,0.1022417,0.1811642,1).rgb, (0.0 /*_Matcap3ColorThemeIndex*/)), float4(0.9822506,0.1022417,0.1811642,1).a);
				}
				else
				{
					matcap3 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap3, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap3)) * float4(poiThemeColor(poiMods, float4(0.9822506,0.1022417,0.1811642,1).rgb, (0.0 /*_Matcap3ColorThemeIndex*/)), float4(0.9822506,0.1022417,0.1811642,1).a);
				}
				#else
				matcap3 = float4(poiThemeColor(poiMods, float4(0.9822506,0.1022417,0.1811642,1).rgb, (0.0 /*_Matcap3ColorThemeIndex*/)), float4(0.9822506,0.1022417,0.1811642,1).a);
				#endif
				...
				if ((1.0 /*_Matcap3HueShiftEnabled*/))
				{
					matcap3.rgb = hueShift(matcap3.rgb, _Matcap3HueShift + _Time.x * (0.0 /*_Matcap3HueShiftSpeed*/));
				}
				blendMatcap(poiLight, poiFragData, poiMods, (1.0 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), (1.0 /*_Matcap3Multiply*/), (1.0 /*_Matcap3Replace*/), (0.0 /*_Matcap3Mixed*/), (0.0 /*_Matcap3Screen*/), matcap3, matcap3Mask, (7.47 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0.1,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0.9921569,0.3529412,0.4627451,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0.9921569,0.3529412,0.4627451,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0.9921569,0.3529412,0.4627451,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
			...
			{
				float2 st = frac(poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (5000.0 /*_GlitterFrequency*/);
				...
				for (int j = -1; j <= 1; j++)
				{
					for (int i = -1; i <= 1; i++)
					{
						...
						float2 rando = pos;
						pos = 0.5 + 0.5 * sin((0.923 /*_GlitterJitter*/) * 6.2831 * pos);
				...
				half3 glitterColor = poiThemeColor(poiMods, float4(1,0.8915094,0.9033902,1), (0.0 /*_GlitterColorThemeIndex*/));
				float3 norm = lerp(poiMesh.normals[0], poiMesh.normals[1], (0.453 /*_GlitterUseNormals*/));
				float3 randomRotation = 0;
				switch((0.0 /*_GlitterMode*/))
				{
					case 0:
					
					if ((0.0 /*_GlitterSpeed*/) > 0)
					{
						randomRotation = randomFloat3WiggleRange(randoPoint, (2.2 /*_GlitterAngleRange*/), (0.0 /*_GlitterSpeed*/));
					}
					else
					{
						randomRotation = randomFloat3Range(randoPoint, (2.2 /*_GlitterAngleRange*/));
					}
					float3 glitterReflectionDirection = normalize(mul(poiRotationMatrixFromAngles(randomRotation), norm));
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.9 /*_GlitterBias*/)), poiCam.viewDir)), (1000.0 /*_GlitterContrast*/)), 0);
					finalGlitter *= glitterAlpha;
					break;
					case 1:
					float offset = random(randoPoint);
					float brightness = sin((_Time.x + offset) * (0.0 /*_GlitterSpeed*/)) * (20.0 /*_glitterFrequencyLinearEmissive*/) - ((20.0 /*_glitterFrequencyLinearEmissive*/) - 1);
				...
				glitterColor *= lerp(1, poiFragData.baseColor, (0.156 /*_GlitterUseSurfaceColor*/));
				#if defined(PROP_GLITTERCOLORMAP) || !defined(OPTIMIZER_ENABLED)
				...
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, finalGlitter * glitterColor * (0.05 /*_GlitterBrightness*/), finalGlitter * glitterTexture.a * glitterMask);
					poiFragData.emission += finalGlitter * glitterColor * max(0, ((0.05 /*_GlitterBrightness*/) - 1) * glitterTexture.a) * glitterMask;
				}
				else
				{
					poiFragData.emission += finalGlitter * glitterColor * (0.05 /*_GlitterBrightness*/) * glitterTexture.a * glitterMask;
				}
			}
			#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (0.5 /*_BumpScale*/));
				#else
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (0.44 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (0.846 /*_RimWidth*/), (0.618 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(1,0.6990172,0.6990172,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftSpeed*/), (0.0 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (0.481 /*_RimBaseColorMix*/), (0.5 /*_RimBrightness*/), (2.0 /*_RimBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, (0.0 /*_RimClamp*/), rimBias, (0.0 /*_RimBiasIntensity*/));
				#endif
				#endif
				#ifdef POI_RIM2
				#ifdef _RIM2STYLE_POIYOMI
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRim2Light*/), (0.0 /*_Rim2LightingInvert*/), (0.53 /*_Rim2Power*/), (0.0 /*_Rim2Strength*/), (0.0 /*_Rim2ShadowWidth*/), (1.0 /*_Rim2ShadowToggle*/), (0.921 /*_Rim2Width*/), (0.114 /*_Rim2BlendStrength*/), rim2Mask, (0.0 /*_Rim2GlobalMask*/), (2.0 /*_Rim2GlobalMaskBlendType*/), rim2Color, float4(1,1,1,1), (0.0 /*_Rim2LightColorThemeIndex*/), (0.0 /*_Rim2HueShiftEnabled*/), (0.0 /*_Rim2HueShift*/), (0.0 /*_Rim2HueShiftSpeed*/), (0.0 /*_Rim2Sharpness*/), (1.0 /*_Rim2ShadowMaskRampType*/), (0.0 /*_Rim2ShadowMaskInvert*/), (1.0 /*_Rim2ShadowMaskStrength*/), float4(0,0.3629422,0,1), (0.0 /*_Rim2ApplyGlobalMaskIndex*/), (2.0 /*_Rim2ApplyGlobalMaskBlendType*/), (0.834 /*_Rim2BaseColorMix*/), (0.36 /*_Rim2Brightness*/), (3.0 /*_Rim2BlendMode*/), AudioLinkRim2WidthBand, AudioLinkRim2WidthAdd, AudioLinkRim2EmissionBand, AudioLinkRim2EmissionAdd, AudioLinkRim2BrightnessBand, AudioLinkRim2BrightnessAdd, (1.0 /*_Rim2Clamp*/), rim2Bias, (0.0 /*_Rim2BiasIntensity*/));
				#endif
				#endif
				#ifdef _SUNDISK_SIMPLE
