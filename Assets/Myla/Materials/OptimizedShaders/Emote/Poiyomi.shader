Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/01375e7b4c270794e849eacad898e427"
{
	Properties
	{
		...
		[sRGBWarning]_RGBMask ("Mask--{reference_properties:[_RGBMaskPan, _RGBMaskUV]}", 2D) = "white" { }
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_GLOBALMASKTEXTURE0) || !defined(OPTIMIZER_ENABLED)
				float4 gmcol0 = POI2D_SAMPLER_PAN(_GlobalMaskTexture0, _MainTex, poiUV(poiMesh.uv[(0.0 /*_GlobalMaskTexture0UV*/)], float4(1,1,0,0)), float4(0,10,0,0));
				if ((1 /*_GlobalMaskTexture0Split*/))
				{
			...
			void calculateRGBNormals(inout PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				{
					#if defined(PROP_RGBMASK) || !defined(OPTIMIZER_ENABLED)
					rgbMask = POI2D_SAMPLER_PAN(_RGBMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RGBMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
					#else
					rgbMask = 1;
					#endif
				}
				...
				if ((1.0 /*_RGBNormalBlend*/) == 0)
				{
					#if defined(PROP_RGBNORMALR) || !defined(OPTIMIZER_ENABLED)
					if ((1.0 /*_RgbNormalRScale*/) > 0)
					{
						half3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalR, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RgbNormalRUV*/)], float4(1,1,0,0)), float4(0,10,0,0), (0.0 /*_RgbNormalRStochastic*/)), (1.0 /*_RgbNormalRScale*/));
						poiMesh.tangentSpaceNormal = lerp(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.r);
					}
					#endif
					#if defined(PROP_RGBNORMALG) || !defined(OPTIMIZER_ENABLED)
					if ((0.0 /*_RgbNormalGScale*/) > 0)
					{
						half3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalG, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RgbNormalGUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_RgbNormalGStochastic*/)), (0.0 /*_RgbNormalGScale*/));
						poiMesh.tangentSpaceNormal = lerp(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.g);
					}
					#endif
					#if defined(PROP_RGBNORMALB) || !defined(OPTIMIZER_ENABLED)
					if ((0.0 /*_RgbNormalBScale*/) > 0)
					{
						half3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalB, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RgbNormalBUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_RgbNormalBStochastic*/)), (0.0 /*_RgbNormalBScale*/));
						poiMesh.tangentSpaceNormal = lerp(poiMesh.tangentSpaceNormal, normalToBlendWith, maskFinal.b);
					}
					#endif
					#if defined(PROP_RGBNORMALA) || !defined(OPTIMIZER_ENABLED)
					if ((0.0 /*_RgbNormalAScale*/) > 0)
					{
						half3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalA, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RgbNormalAUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_RgbNormalAStochastic*/)), (0.0 /*_RgbNormalAScale*/));
				...
				else
				{
					...
					#if defined(PROP_RGBNORMALR) || !defined(OPTIMIZER_ENABLED)
					normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalR, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RgbNormalRUV*/)], float4(1,1,0,0)), float4(0,10,0,0), (0.0 /*_RgbNormalRStochastic*/)), (1.0 /*_RgbNormalRScale*/) * maskFinal.r);
					newNormal = BlendNormals(newNormal, normalToBlendWith);
					#endif
					#if defined(PROP_RGBNORMALG) || !defined(OPTIMIZER_ENABLED)
					normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalG, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RgbNormalGUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_RgbNormalGStochastic*/)), (0.0 /*_RgbNormalGScale*/) * maskFinal.g);
					newNormal = BlendNormals(newNormal, normalToBlendWith);
					#endif
					#if defined(PROP_RGBNORMALB) || !defined(OPTIMIZER_ENABLED)
					normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalB, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RgbNormalBUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_RgbNormalBStochastic*/)), (0.0 /*_RgbNormalBScale*/) * maskFinal.b);
					newNormal = BlendNormals(newNormal, normalToBlendWith);
					#endif
					#if defined(PROP_RGBNORMALA) || !defined(OPTIMIZER_ENABLED)
					normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalA, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RgbNormalAUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_RgbNormalAStochastic*/)), (0.0 /*_RgbNormalAScale*/) * maskFinal.a);
					newNormal = BlendNormals(newNormal, normalToBlendWith);
					#endif
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#if defined(PROP_REDTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float4 red = POI2D_SAMPLER_PAN_STOCHASTIC(_RedTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RedTextureUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_RedTextureStochastic*/));
				#else
				float4 red = 1;
				#endif
				#if defined(PROP_GREENTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float4 green = POI2D_SAMPLER_PAN_STOCHASTIC(_GreenTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_GreenTextureUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_GreenTextureStochastic*/));
				#else
				float4 green = 1;
				#endif
				#if defined(PROP_BLUETEXTURE) || !defined(OPTIMIZER_ENABLED)
				float4 blue = POI2D_SAMPLER_PAN_STOCHASTIC(_BlueTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BlueTextureUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_BlueTextureStochastic*/));
				#else
				float4 blue = 1;
				#endif
				#if defined(PROP_ALPHATEXTURE) || !defined(OPTIMIZER_ENABLED)
				float4 alpha = POI2D_SAMPLER_PAN_STOCHASTIC(_AlphaTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_AlphaTextureUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_AlphaTextureStochastic*/));
				#else
				float4 alpha = 1;
				#endif
				float4 maskFinal = 1;
				maskFinal.r = red.a   * saturate((rgbMask[(0.0 /*_RgbRedMaskChannel*/)  ] * float4(1,1,1,1).a  ) + (0.0 /*_RedAlphaAdd*/)  );
				maskFinal.g = green.a * saturate((rgbMask[(1.0 /*_RgbGreenMaskChannel*/)] * float4(1,1,1,0).a) + (0.0 /*_GreenAlphaAdd*/));
				maskFinal.b = blue.a  * saturate((rgbMask[(2.0 /*_RgbBlueMaskChannel*/) ] * float4(1,1,1,0).a ) + (0.0 /*_BlueAlphaAdd*/) );
				maskFinal.a = alpha.a * saturate((rgbMask[(3.0 /*_RgbAlphaMaskChannel*/)] * float4(1,1,1,0).a) + (0.0 /*_AlphaAlphaAdd*/));
				if ((0.0 /*_RgbRedGlobalMaskChannel*/)   > 0) maskFinal.r = customBlend(maskFinal.r, poiMods.globalMask[(0.0 /*_RgbRedGlobalMaskChannel*/)-1],   (2.0 /*_RgbRedGlobalMaskBlendType*/)  );
				if ((0.0 /*_RgbGreenGlobalMaskChannel*/) > 0) maskFinal.g = customBlend(maskFinal.g, poiMods.globalMask[(0.0 /*_RgbGreenGlobalMaskChannel*/)-1], (2.0 /*_RgbGreenGlobalMaskBlendType*/));
				if ((0.0 /*_RgbBlueGlobalMaskChannel*/)  > 0) maskFinal.b = customBlend(maskFinal.b, poiMods.globalMask[(0.0 /*_RgbBlueGlobalMaskChannel*/)-1],  (2.0 /*_RgbBlueGlobalMaskBlendType*/) );
				if ((0.0 /*_RgbAlphaGlobalMaskChannel*/) > 0) maskFinal.a = customBlend(maskFinal.a, poiMods.globalMask[(0.0 /*_RgbAlphaGlobalMaskChannel*/)-1], (2.0 /*_RgbAlphaGlobalMaskBlendType*/));
				if ((1.0 /*_RGBBlendMultiplicative*/))
				{
					float3 RGBColor = 1;
					RGBColor = lerp(RGBColor, red.rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_RedColorThemeIndex*/)), maskFinal.r);
					RGBColor = lerp(RGBColor, green.rgb * poiThemeColor(poiMods, float4(1,1,1,0).rgb, (0.0 /*_GreenColorThemeIndex*/)), maskFinal.g);
					RGBColor = lerp(RGBColor, blue.rgb * poiThemeColor(poiMods, float4(1,1,1,0).rgb, (0.0 /*_BlueColorThemeIndex*/)), maskFinal.b);
					RGBColor = lerp(RGBColor, alpha.rgb * poiThemeColor(poiMods, float4(1,1,1,0).rgb, (0.0 /*_AlphaColorThemeIndex*/)), maskFinal.a);
					poiFragData.baseColor *= RGBColor;
				}
				else
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, red.rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_RedColorThemeIndex*/)), maskFinal.r);
					poiFragData.baseColor = lerp(poiFragData.baseColor, green.rgb * poiThemeColor(poiMods, float4(1,1,1,0).rgb, (0.0 /*_GreenColorThemeIndex*/)), maskFinal.g);
					poiFragData.baseColor = lerp(poiFragData.baseColor, blue.rgb * poiThemeColor(poiMods, float4(1,1,1,0).rgb, (0.0 /*_BlueColorThemeIndex*/)), maskFinal.b);
					poiFragData.baseColor = lerp(poiFragData.baseColor, alpha.rgb * poiThemeColor(poiMods, float4(1,1,1,0).rgb, (0.0 /*_AlphaColorThemeIndex*/)), maskFinal.a);
				}
			}
			#endif
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				switch((1.0 /*_MatcapUVMode*/))
				{
					case 0:
					{
						...
						matcapUV = noSknewViewNormal.rg * (0.48 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 1:
					{
						...
						matcapUV = float2(dot(worldViewRight, normal0), dot(worldViewUp, normal0)) * (0.48 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 2:
					{
						...
						matcapUV = uv * (0.48 /*_MatcapBorder*/) + 0.5;
						break;
					}
				}
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					...
					matcapSmoothness = (0.872 /*_MatcapSmoothness*/);
				...
				#endif
				matcap.rgb *= (1.28 /*_MatcapIntensity*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (1.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (1.0 /*_MatcapMaskGlobalMask*/), (1.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				switch((0.0 /*_GlitterMode*/))
				{
					...
					{
						randomRotation = randomFloat3WiggleRange(randoPoint, (7.0 /*_GlitterAngleRange*/), (10.0 /*_GlitterSpeed*/));
					}
					else
					{
						randomRotation = randomFloat3Range(randoPoint, (7.0 /*_GlitterAngleRange*/));
					}
				...
				if ((2.0 /*_GlitterMaskGlobalMask*/) > 0)
				{
					glitterMask = maskBlend(glitterMask, poiMods.globalMask[(2.0 /*_GlitterMaskGlobalMask*/) - 1], (2.0 /*_GlitterMaskGlobalMaskBlendType*/));
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(3,1,0,0)), float4(5,5,0,0), (0.0 /*_BumpMapStochastic*/)), (1.0 /*_BumpScale*/));
				#else
