Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/2248c50a407f7b24d9050409f301f340"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionMask0 = maskBlend(emissionMask0, poiMods.globalMask[(0.0 /*_EmissionMask0GlobalMask*/) - 1], (0.0 /*_EmissionMask0GlobalMaskBlendType*/));
				}
