Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/7240ca0c3b2c5c74bbd13faeecf53337"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalRotation = (180.0 /*_DecalRotation*/);
				Decal0.m_DecalScale = float4(0.3,0.3,0,0);
				Decal0.m_DecalSideOffset = float4(0,0,0,0);
				Decal0.m_DecalPosition = float4(0.52,0.76,0,0);
