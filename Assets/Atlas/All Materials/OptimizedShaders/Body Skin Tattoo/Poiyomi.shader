Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/0fb61a143f816f94ab4a61c2d328bd87"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 8192) mipCount2 = 13;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 4096) mipCount2 = 12;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 2048) mipCount2 = 11;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 1024) mipCount2 = 10;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 512) mipCount2 = 9;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 256) mipCount2 = 8;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 128) mipCount2 = 7;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 64) mipCount2 = 6;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 32) mipCount2 = 5;
				...
				if ((0.0 /*_Matcap3SmoothnessEnabled*/))
				{
					matcap3 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap3, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap3), matcap3Smoothness) * float4(poiThemeColor(poiMods, float4(0.3762622,0.1022417,0.9822506,1).rgb, (0.0 /*_Matcap3ColorThemeIndex*/)), float4(0.3762622,0.1022417,0.9822506,1).a);
				}
				else
				{
					matcap3 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap3, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap3)) * float4(poiThemeColor(poiMods, float4(0.3762622,0.1022417,0.9822506,1).rgb, (0.0 /*_Matcap3ColorThemeIndex*/)), float4(0.3762622,0.1022417,0.9822506,1).a);
				}
				#else
				matcap3 = float4(poiThemeColor(poiMods, float4(0.3762622,0.1022417,0.9822506,1).rgb, (0.0 /*_Matcap3ColorThemeIndex*/)), float4(0.3762622,0.1022417,0.9822506,1).a);
				#endif
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0.1,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0.6470588,0.3529412,0.9921569,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0.6470588,0.3529412,0.9921569,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0.6470588,0.3529412,0.9921569,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
