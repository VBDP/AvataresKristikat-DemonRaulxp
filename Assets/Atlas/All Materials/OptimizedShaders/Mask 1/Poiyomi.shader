Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/6218c93e8d951ba45b4cb3db402c69e2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), -((4.68 /*_Saturation*/)) * hueShiftAlpha.b);
